# Generated by Django 5.1.4 on 2025-08-27 15:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='Phone must be in format +1234567890 or 123-456-7890', regex='^(\\+?\\d{10,15}|\\d{3}-\\d{3}-\\d{4})$')])),
            ],
        ),
        migrations.CreateModel(
            name='Product',
